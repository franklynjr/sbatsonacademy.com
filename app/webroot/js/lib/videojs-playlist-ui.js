    ...
    createEl: {
      value: function createEl() {
        ...
        if (item.description) {
          ...
          description.appendChild(document.createTextNode(_description.textContent || _description.innerText || ""));
          
          description.setAttribute("title",_description.textContent || _description.innerText || "");
