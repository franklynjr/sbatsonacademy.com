    ...
    <div class="intro-container container section-container">
        <div class="intro-section row section">
            <div class="col-lg-6 intro-gradient">
                        <h3 class="section-title"> Welcome to The Seon Batson Academy! </h3>
                        <p class="description">The Seon Batson Academy is a Private Institution that 
    ...
    <div id="myCarousel" class="carousel slide" data-ride="carousel">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img class="first-slide" src="/img/photo-1434626881859-194d67b2b86f.jpg" alt="First slide">
          
        </div>
        <div class="item">
          <img class="second-slide" src="/img/photo-1434030216411-0b793f4b4173.jpg" alt="Second slide">
          
        </div>
        <div class="item">
          <img class="third-slide" src="/img/photo-1454165804606-c3d57bc86b40.jpg" alt="Third slide">
        </div>
      </div>
                ...
                <div class="col-lg-6">
                    <div class="col-lg-8 col-md-12">
                        ...
                        <div>
                            <div>
                                <div>
                                    <p class="description">We are proud of our work at The Seon Batson Academy. 
                                        To find out why, visit us, or sit in on a class or workshop with no obligation to you.</p>
                                </div>
                            </div>
                        </div>
                    </div>
